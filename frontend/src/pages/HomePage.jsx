  ...
  return (
    <div className="app-surface min-h-screen text-[#334155]">
      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
        <section className="relative overflow-hidden rounded-4xl border border-white bg-linear-to-br from-[#FFF1F7] via-white to-[#E0F2FE] p-6 shadow-[0_20px_60px_rgba(51,65,85,0.10)] sm:p-9 lg:grid lg:grid-cols-[1.15fr_0.85fr] lg:gap-10 lg:p-12">
          <div className="relative z-10 flex flex-col items-start justify-center">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-[#64748B] sm:text-lg">
              INNER-NET listens to your ideas, helps you spot the next step, and
              lets you discover the answer yourself.
            </p>
            ...
            <div className="relative rounded-[1.75rem] border border-white bg-white/75 p-5 shadow-[0_18px_45px_rgba(14,165,233,0.12)] backdrop-blur sm:p-6">
              ...
              <div className="mt-5 space-y-3">
                {[
                  ...
                  <div
                    key={number}
                    className="flex items-center gap-3 rounded-2xl bg-[#F8FAFC] p-3.5"
                  >
                    <span className="grid size-8 shrink-0 place-items-center rounded-xl bg-white text-sm font-bold text-[#0284C7] shadow-sm">
                      {number}
                    </span>
                    <span className="text-sm font-medium text-[#475569] sm:text-base">
                      {text}
                    </span>
                  </div>
                ))}
        ...
        <section className="py-10 sm:py-12" aria-labelledby="begin-heading">
          <div className="mb-6 flex flex-col justify-between gap-2 sm:flex-row sm:items-end">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#F472B6]">
                Your learning space
              </p>
              <h2
                id="begin-heading"
                className="mt-2 text-2xl font-bold text-[#334155] sm:text-3xl"
              >
            ...
            <p className="max-w-md text-sm leading-6 text-[#64748B] sm:text-right">
              ...
              <br />
              Pick what feels closest to what you need.
            </p>
          </div>

          <div className="grid gap-4 md:grid-cols-3">
            {starters.map(
              ({ title, description, prompt, icon: Icon, color }) => (
                <button
                  key={title}
                  type="button"
                  onClick={() => openStarter(prompt)}
                  className="group flex min-h-52 flex-col items-start rounded-3xl border border-[#E2E8F0] bg-white p-5 text-left shadow-[0_10px_30px_rgba(51,65,85,0.06)] transition hover:-translate-y-1 hover:border-[#F9A8D4] hover:shadow-[0_16px_35px_rgba(244,114,182,0.14)] sm:p-6"
                >
                  <span
                  ...
                  <h3 className="mt-5 text-xl font-bold text-[#334155]">
                    {title}
                  </h3>
        ...
        <section className="grid overflow-hidden rounded-[1.75rem] border border-[#E2E8F0] bg-white sm:grid-cols-3">
          {[
            ...
            [
              Brain,
              "You stay in control",
              "You do the thinking; we guide the next step.",
            ],
            ...
            >
              <Icon
                className="mt-0.5 size-5 shrink-0 text-[#F472B6]"
                aria-hidden="true"
              />
              <div>
