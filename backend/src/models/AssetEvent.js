...
const schema = new mongoose.Schema({
  cardId: { type: mongoose.Schema.Types.ObjectId, ref: "CardInstance", required: true },
  operationId: { type: String, required: true },
  eventType: { type: String, enum: ["fixture_created", "reward_granted", "trade_transferred"], required: true },
